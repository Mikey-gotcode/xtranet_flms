      ...
      <div class="users dropdown-menu dropdown-menu-right" data-popper-placement="bottom-end">
        <div class="user-header">
          <div class="avatar avatar-sm">
            <img src="@/assets/img/user/user16.jpg" alt="User Image" class="avatar-img rounded-circle">
          </div>
          <div class="user-text">
            <h6>Rolands R</h6>
        ...
        <router-link class="dropdown-item" to="/student/student-dashboard"><i class="feather-home me-1"></i> Dashboard</router-link>
        <router-link class="dropdown-item" to="/student/student-settings"><i class="feather-user me-1"></i> Profile</router-link>
        <router-link class="dropdown-item" to="/student/setting-student-subscription"><i class="feather-star me-1"></i>
