                  ...
                  <table class="table table-nowrap mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span class="title-course"
                            >AngularJS and Angular refer to the same framework.</span
                          >
                        </td>
                        <td>
                          <span class="title-course"
                            >Learn Angular Fundamentals Beginners Guide</span
                          >
                        </td>
                        <td>
                        ...
                        <td>March 24, 2024 <span class="d-block">09:30 AM</span></td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="title-course"
                            >What is the purpose of Angular's NgIf directive?</span
                          >
                        </td>
                        <td>
                          <span class="title-course"
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="title-course"
                            >Observables are not part of Angular's HTTP module.</span
                          >
                        </td>
                        <td>
                          <span class="title-course"
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="title-course"
                            >Which of the following is a valid way to bind data in
                            Angular?</span
                          >
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="title-course"
                            >Angular applications can only be written in TypeScript.</span
                          >
                        </td>
                        <td>
                          <span class="title-course"
