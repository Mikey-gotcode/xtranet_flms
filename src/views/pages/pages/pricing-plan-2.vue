        ...
        <div class="row">
          <div class="col-lg-5 text-center mx-auto">
            <div class="title-sec">
              ...
              <p>
                Improve the way your work, discover a brand new tool and drop the hassle
                once and for all.
              </p>
            </div>
            <div class="text-end">
          ...
          <div class="row">
            <div class="col-md-4 d-flex">
              <div class="price-box w-100">
                <h4>Basic</h4>
                <p>
                  For individuals who just need to start with the basic features per user,
            ...
            <div class="col-md-4 d-flex">
              <div class="price-box w-100">
                ...
                <p>
                  For teams who just need to start with the basic features per user, per
            ...
            <div class="col-md-4 d-flex">
              <div class="price-box w-100">
                <h4>Pro</h4>
                <p>
                  For medium businesses who need advanced features for their activity per
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <img src="@/assets/img/icon/check-circle.svg" alt="icon" />
                    </td>
                    <td class="text-center">
                      <img src="@/assets/img/icon/check-circle.svg" alt="icon" />
                    </td>
                  ...
                  <tr>
                    <td>Multi-device</td>
                    <td class="text-center">
                      <img src="@/assets/img/icon/close-circle.svg" alt="icon" />
                    </td>
                    <td class="text-center">
                      <img src="@/assets/img/icon/check-circle.svg" alt="icon" />
                    </td>
